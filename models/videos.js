...
videosModel.populateData = function(){
	var videos=Array();
	...
	videos.push({name: 'Google Cardboard Assembly', description:'Google Cardboard Assembly Step by Step Instructions [HD]', url:'videos/Google_Cardboard_Assembly.mp4', rattings:[4,5,5,5,3,5,4,5]});
	videos.push({name: 'How Does AngularJS Work Beginners Angular Tutorial', description: 'What you will learn in this course. How to use Angular.js to save time, create better projects and give your users a better experience. We’ll create a full SPA from scratch (client side). How to cloud-enable your SPA so that you can connect it to any kind of backend. Fully commented source code of the course project. Learn how to architecture a SPA: modules, controllers, services Learn how to add URL routes to your client-side SPA. We’ll be using Angular.js version 1.3.2. Access live examples at the end of each coding lesson. Learn how to use other great tools such as Boostrap 3, UnderscoreJS and Google Chrome’s Developer Tools!', url:'videos/How_Does_AngularJS_Work_Beginners_Angular_Tutorial.mp4', rattings:[2,4,2,2,3,1,2,5]});
	videos.push({name: 'How does Node.js work', description:'New to Node.js? Check out this video that explains "How does Node work?"', url:'videos/How_does_Node.js_work.mp4', rattings:[3,3,3,3,3,3,3,3]});
	videos.push({name: 'iPhone 7 Trailer 2016', description:'iPhone 7 concept trailer 2016! with Bluetooth AirPods by Beats and ChargingPad, and much more!', url:'videos/iPhone_7_Trailer_2016.mp4', rattings:[4,3,4,3,4,3,4,3]});
	videos.push({name: 'What is the MEAN Stack', description:'Do you know what the MEAN stack is? Watch our short intro video and get ready to kick your learning into shape with this full-stack development toolkit. Then head on over and play through our MEAN-related courses now.', url:'videos/What_is_the_MEAN_Stack.mp4', rattings:[1,5,5,5,3,4,5,5]});
	...
	Video.collection.insert(dataToInsert, function(err, video) {
		if(err){
			...
			console.dir('Videos table populated.');	
		}	
	});
